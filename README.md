...
# Optional MONGO_KEY, if you decide the inject the value for the keyfile rather than using the generated keyfile, you can use the environment variable instead
